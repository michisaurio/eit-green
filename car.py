...
class Car:
    ...
    def __init__(self, id: int, position: [float,float], speed: float = 0, parameter: float = 0, orientation: float=0, road: road.Road = None, lane: lane.Lane = None, nextLane: lane.Lane = None, carInFront: "Car" = None, waitTime: float = 0, comfortabilityConstant = 3) -> None:
        self.id = id
