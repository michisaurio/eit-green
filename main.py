...
def main():
    lane1 = Lane(coordinates=[0,375,300,375], speedLimit=120, curveType="line", spawnRate=0)
    lane2 = Lane(coordinates = [300,425,0,425], speedLimit = 120, curveType="line")
    lane3 = Lane(coordinates=[375, 800, 375, 500], speedLimit=120, curveType="line", spawnRate=0.5)
    ...
    lane11 = Lane(coordinates=[300, 375, 375, 500], speedLimit=120, curveType="ellipsis", isClockWise=0, nextLanes=[(lane4, 1)])
